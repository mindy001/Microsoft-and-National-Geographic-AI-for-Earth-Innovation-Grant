...
def argparser():
    ...
    parser.add_argument("--n_epochs", default=50, type=int, help="number of epoch")
    parser.add_argument(
        "--epoch_steps", default=100, type=int, help="number of epoch step"
    )
    parser.add_argument(
        "--val_steps", default=2, type=int, help="number of valdation step"
    )
...
def main(args):
    ...
    train_list = pd.read_csv('gdrive/My Drive/Research/TTLAB/AI_For_Earth/Problem_2/test_2/train.csv')
    ...
    addtional = 50
    train_resume = True
    weights_path = 'gdrive/My Drive/Research/TTLAB/AI_For_Earth/Problem_2/test_2/' + str(600) + ".hdf5"
    print(weights_path)
    if train_resume:
    ...
    model.save_weights('gdrive/My Drive/Research/TTLAB/AI_For_Earth/Problem_2/test_2/' + str(650) + ".hdf5")
